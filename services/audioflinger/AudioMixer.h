...
private:
    ...
    typedef void (*mix_t)(state_t* state, AudioDSP& dsp);
    typedef void (*hook_t)(track_t* t, int32_t* output, size_t numOutFrames, int32_t* temp, int32_t* aux, AudioDSP& dsp);
    ...
    struct track_t {
        ...
        void        adjustVolumeRamp(bool aux, AudioDSP& dsp, size_t frames);
    };
    ...
    static void track__genericResample(track_t* t, int32_t* out, size_t numFrames, int32_t* temp, int32_t* aux, AudioDSP& dsp);
    static void track__nop(track_t* t, int32_t* out, size_t numFrames, int32_t* temp, int32_t* aux, AudioDSP& dsp);
    static void track__16BitsStereo(track_t* t, int32_t* out, size_t numFrames, int32_t* temp, int32_t* aux, AudioDSP& dsp);
    static void track__16BitsMono(track_t* t, int32_t* out, size_t numFrames, int32_t* temp, int32_t* aux, AudioDSP& dsp);
    static void volumeRampStereo(track_t* t, int32_t* out, size_t frameCount, int32_t* temp, int32_t* aux, AudioDSP& dsp);
